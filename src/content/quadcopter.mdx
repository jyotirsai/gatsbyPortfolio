---
title: "Quadcopter: Physics and Components"
slug: quadcopter
date: 2020-03-21
excerpt: A general overview on how quadcopters work and the components that make them up.
type: Robotics
---
...
There are three dimensions in which a flying object can move through: pitch, yaw, and roll. Pitch refers to moving the nose of an aircraft up and down. Yaw refers to moving the nose of an aircraft left and right.
...
<Typography variant="h4">Mechanical Components</Typography>
